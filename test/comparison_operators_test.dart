...
void main() {
  ...
  group("eq command -> ", () {
    ...
    test(
      "should check one different and two equal values together with eq",
      () async {
    ...
    test(
      "should use two args with eq to compare multiple equal values",
      () async {
        var vals1 = [10, 10, 10];
        var vals2 = [20, 20, 20];
        var result = await r
            .eq(r.args(vals1))
            .eq(r.eq(r.args(vals2)))
            .run(connection);
        expect(result, equals(true));
      },
    );
    test(
      "should use two args with eq to compare multiple different values",
      () async {
        var vals1 = [10, 10, 10];
        var vals2 = [10, 20, 20];
        var result = await r
  ...
  group("ne command -> ", () {
    ...
    test(
      "should check one different and two equal values together with ne",
      () async {
    ...
    test(
      "should use two args with ne to compare multiple equal values",
      () async {
        var vals1 = [10, 10, 10];
        var vals2 = [20, 20, 20];
        var result = await r
            .ne(r.args(vals1))
            .ne(r.ne(r.args(vals2)))
            .run(connection);
        expect(result, equals(false));
      },
    );
    test(
      "should use two args with ne to compare multiple different values",
      () async {
        var vals1 = [10, 10, 10];
        var vals2 = [10, 20, 20];
        var result = await r
  ...
  group("lt command -> ", () {
    ...
    test(
      "should use args with lt to compare multiple decreasing values",
      () async {
        var vals = [30, 20, 10];
        var result = await r.lt(r.args(vals)).run(connection);
        expect(result, equals(false));
  ...
  group("le command -> ", () {
    ...
    test(
      "should use args with le to compare multiple decreasing values",
      () async {
        var vals = [30, 20, 10];
        var result = await r.le(r.args(vals)).run(connection);
        expect(result, equals(false));
  ...
  group("gt command -> ", () {
    ...
    test(
      "should use args with gt to compare multiple decreasing values",
      () async {
        var vals = [30, 20, 10];
        var result = await r.gt(r.args(vals)).run(connection);
        expect(result, equals(true));
  ...
  group("ge command -> ", () {
    ...
    test(
      "should use args with ge to compare multiple decreasing values",
      () async {
        var vals = [30, 20, 10];
        var result = await r.ge(r.args(vals)).run(connection);
        expect(result, equals(true));
