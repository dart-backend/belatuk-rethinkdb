...
void main() {
  ...
  group("hasFields command -> ", () {
    test(
      "should use hasFields and return the people who have children",
      () async {
  ...
  group("values command -> ", () {
    test(
      "should return the values from the person with id equal to 1",
      () async {
        var personValues = await r
            .table(tableName!)
            .get(1)
            .values()
            .run(connection);
