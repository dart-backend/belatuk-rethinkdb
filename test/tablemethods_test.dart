...
void main() {
  ...
  group("tableDrop command -> ", () {
    ...
    test(
      "should throw an `ReqlOpFailedError` if the table doesn't exist",
      () async {
        try {
  ...
  test(
    "tableList command -> should list all tables for the database",
    () async {
  ...
  group("indexCreate command -> ", () {
    ...
    test(
      "should create a new index with an index function as `r.row`",
      () async {
        Map ind = await r
            .table('unitTestTable3')
