...
void main() {
  ...
  group("circle command -> ", () {
    ...
    test(
      "should create a polygon with a specified number of vertices",
      () async {
        Point p = r.point(long, lat);
  ...
  group("includes command -> ", () {
    test(
      "should return true if a geometry includes some other geometry",
      () async {
  ...
  group("intersects command -> ", () {
    test(
      "should return true if a geometry intersects some other geometry",
      () async {
        Point point1 = r.point(-117.220406, 32.719464);
  ...
  group("line command -> ", () {
    ...
    test(
      "should create a line from a combination of arrays and points",
      () async {
        Map line = await r
  ...
  test(
    "point command -> should create a point given a longitude and latitude",
    () async {
